...
Breadcrumbs::for('dashboard.categories.index', function ($breadcrumb) {
    ...
    $breadcrumb->push(trans('attributes::categories.plural'), route('dashboard.categories.index'));
});

Breadcrumbs::for('dashboard.categories.create', function ($breadcrumb) {
    $breadcrumb->parent('dashboard.categories.index');
    $breadcrumb->push(trans('attributes::categories.actions.create'), route('dashboard.categories.create'));
});
...
Breadcrumbs::for('dashboard.categories.edit', function ($breadcrumb, $category) {
    ...
    $breadcrumb->push(trans('attributes::categories.actions.edit'), route('dashboard.categories.edit', $category));
});
